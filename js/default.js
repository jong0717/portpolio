...
$('.pop').on('click', function (e) {
    let target = e.target;
    if ($(this).children().hasClass('pop__full_layer')) {
        return;
    } else if (
        $(target).hasClass('btn__btn_line') ||
        $(target).hasClass('btn__btn_default') ||
        $(target).hasClass('pop_alert__btn_cls') ||
        $(target).hasClass('pop__bg') ||
        $(target).hasClass('pop_evnt__bg') ||
        $(target).hasClass('btn__btn')
    ) {
